...
PLANET_KAGGLE_ROOT = os.path.abspath("/media/jiapei/Seagate/Competitions/Kaggle/02_Planet-UnderstandingtheAmazonfromSpace/")
...
labels_hist=labels_df[label_list].sum().sort_values();
ax = labels_hist.plot(kind='bar', title ='Histogram of labels', figsize=(15, 10), legend=True, fontsize=12)
